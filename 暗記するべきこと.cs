...
namespace HL_塾管理
{
    public partial class 暗記するべきこと : Form
    {
        ...
        private void 暗記するべきこと_Load(object sender, EventArgs e)
        {
            TreeViewLoad();
        }

        private void 暗記するべきこと_FormClosed(object sender, FormClosedEventArgs e)
        {
            //((Form1)(Tag)).m_履歴書作成注意点Handle = IntPtr.Zero;
            ((Form1)(Tag)).toolStripStatusLabel2.Text = "";
        }

        private void 暗記するべきこと_Resize(object sender, EventArgs e)
        {
        ...
        private void treeView1_AfterSelect(object sender, TreeViewEventArgs e)
        {
            ...
            備考.Text = dt_TreeViewSelect.Rows[0]["備考"].ToString();
        }
    }
